package pl.zdunek.myapp.web.rest;

import pl.zdunek.myapp.MyApp;
import pl.zdunek.myapp.config.audit.AuditEventConverter;
import pl.zdunek.myapp.domain.PersistentAuditEvent;
import pl.zdunek.myapp.repository.PersistenceAuditEventRepository;
import pl.zdunek.myapp.service.AuditEventService;
